...
public class WordCount {
    ...
    public static void main(String[] args) {
        String textFilePath = "hdfs://172.20.10.3:9000/sparkApp/input/pigs.txt"; //CHANGE THIS PATH TO HDFS URL
        ...
        reducedCounts
                ...
                .coalesce(1)
                .saveAsTextFile("hdfs://172.20.10.3:9000/sparkApp/output"); //print the word count and save the output in the format, e.g.,(in:15) to an 'output' folder (on HDFS for task 2)
